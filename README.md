...
- 이 코스는 Python을 이용하여 기초부터 고급까지 학습 하데 코어 프로그램을 하고 싶은 분들에게 추천 드립니다.
- 단순 문법 설명이 아니라 코어를 설계 할 수 있는 능력을 배양하기 위해서 개발된 교재 입니다.
- 샘플 코드는 직접 만들었고 문서 설명은 AI를 이용하여 추가하거나 보충 하였습니다.
