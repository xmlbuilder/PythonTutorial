# 🧠 Sequence 개념 요약
- Python의 시퀀스(Sequence) 관련 핵심 개념들을 튜플, 가변/불변 객체, 정렬 방식 중심으로 정리한 요약 입니다:


## ✅ 시퀀스란?
- 순서가 있는 자료형
- 대표적으로 list, tuple, str, range, array 등이 있음
...
- x[-1]는 문자열의 마지막 문자를 의미합니다.
  - 예: '10'[-1] → '0'
  - '12'[-1] → '2'
  - '4'[-1]  → '4'
- 따라서 출력에서 보이는 값들은 각 문자열의 마지막 글자입니다.
